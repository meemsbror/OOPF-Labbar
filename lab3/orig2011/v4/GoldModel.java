...
public class GoldModel implements GameModel {
	...
	private static final orig2011.v3.GameTile COIN_TILE = new orig2011.v3.RoundTile(new Color(255, 215,
			0),
			new Color(255, 255, 0), 2.0);

	/** Graphical representation of the collector */
	private static final orig2011.v3.GameTile COLLECTOR_TILE = new orig2011.v3.RoundTile(Color.BLACK,
			Color.RED, 2.0);

	/** Graphical representation of a blank tile. */
	private static final orig2011.v3.GameTile BLANK_TILE = new BlankTile();
	...
	public GoldModel() {
		this.gameboardState =
				new orig2011.v3.GameTile[this.gameboardSize.width][this.gameboardSize.height];
	 ...
	 */
	public orig2011.v3.GameTile getGameboardState(final Position pos){
	 ...
	 *            Coordinate in the gameboard matrix.
	 */
	public orig2011.v3.GameTile getGameboardState(final int x, final int y){
